...
main()
{
	...
	{
		settextstyle(2,0,5);
		outtextxy(100,10,(char*)"Press L,H ,T,P");
		outtextxy(100,30,(char*)"Press 1 for Quit");
		as:
		setcolor(13);
		ellipse(380,127,20,158,130,35);
		...
		ellipse(512,144,300,50,10,12);
		ellipse(467,143,28,100,50,30);
		line(498,120,521,138);
		...
		int b,x,y;
			...
			////////////////lower
		line(365,298,526,264);
		line(365,298,330,310);
		line(330,310,321,310);
		
		/////////////////bumper
	
		ellipse(162,221,135,193,90,40);
		line(96,193,140,174);
		line(140,174,160,168);
		line(160,168,192,161);
	
			//////////////////////front
		ellipse(75,247,89,193,18,18);
		line(57,249,57,286);
		...
		ellipse(197,167,228,246,200,90);
		...
		line(532+v,211+b,542+v,224+b);
		line(555+v,235+b,566+v,245+b);
		...
		v=v+5;
		line(555+v,225+b,570+v+3,225+b);
		line(555+v-1,230+b,570+v+3,230+b);
		...
		////////////////light
		ellipse(167,247,99,360,8,8);
		ellipse(170,243,310,129,9,7);
		putpixel(174,250,13);
		putpixel(173,251,13);
		putpixel(164,239,13);
		putpixel(165,238,13);
...
//		//		//////////////////////
				...
				floodfill(587,71,13);
//		
				setfillstyle(9,14); //////////////////////////ty
				floodfill(548,250,13);
				floodfill(548,214,13);
				floodfill(533,228,13);
				floodfill(563,228,13);
				floodfill(262,281,13);
				floodfill(300,281,13);
				floodfill(284,251,13);
				floodfill(284,295,13);//////////////yellowtyre
//		
//		//		////////////////////////////////////////road
...
//		//		///light
				setfillstyle(9,11);                             ///////////
				floodfill(80,235,13);
				floodfill(223,234,13);
				floodfill(172,250,13);
				delay(120);
...
//				floodfill(617,183,12);
				...
				floodfill(294,295,13);
				floodfill(274,265,13);
				floodfill(294,265,13);///////////////green tyre
//		
//		//		////////////////////////////////////////////////road
...
//				floodfill(80,230,13);
		...
		if(t=='p')
		{
			...
			while(!kbhit())
		    {
				...
				if(n==60)
		        {
					outtextxy(10,10,(char*)"L-LIGHTS");
					outtextxy(10,20,(char*)"H-HORN");
					outtextxy(10,30,(char*)"T-AllOY");
					delay(400);
	           	}
      	   }
			setcolor(0);
